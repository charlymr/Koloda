...
public class KolodaViewAnimator {
    ...
    public func applyScaleAnimation(card: DraggableCardView, scale: CGSize, frame: CGRect, duration: TimeInterval, completion: AnimationCompletionBlock = nil) {
    ...
    public func applyAlphaAnimation(card: DraggableCardView, alpha: CGFloat, duration: TimeInterval = 0.2, completion: AnimationCompletionBlock = nil) {
    ...
    internal func resetBackgroundCardsWithCompletion(completion: AnimationCompletionBlock = nil) {
        UIView.animate(
            ...
            options: .curveLinear,
            animations: {
                self.koloda?.moveOtherCardsWithPercentage(percentage: 0)
            },
            completion: { finished in
                completion?(finished)
        })
