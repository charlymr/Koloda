...
public class DraggableCardView: UIView, UIGestureRecognizerDelegate {
    ...
    private var dragDistance = CGPoint()
    ...
    private func setup() {
        panGestureRecognizer = UIPanGestureRecognizer(target: self, action: #selector(DraggableCardView.panGestureRecognized(gestureRecognizer:)))
        addGestureRecognizer(panGestureRecognizer)
        panGestureRecognizer.delegate = self
        tapGestureRecognizer = UITapGestureRecognizer(target: self, action: #selector(DraggableCardView.tapRecognized(recogznier:)))
    ...
    private func resetViewPositionAndTransformations() {
        ...
        resetPositionAnimation?.toValue = NSValue(cgPoint: CGPoint())
